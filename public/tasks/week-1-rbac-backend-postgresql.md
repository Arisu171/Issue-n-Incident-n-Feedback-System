...
| Entity, `AppDbContext`, khoá chính kép, unique index | Developer | Nguyễn Huy Kiên | `Domain/Entities.cs`, `Persistence/AppDbContext.cs` |
| Migration đầu tiên, seeder vai trò và tài khoản bootstrap | Developer | Lê Sơn Trường | `Persistence/Migrations/`, `DatabaseInitializer.cs` |
| Controller CRUD user / role / permission | Developer | Nguyễn Huy Kiên | `Modules/Rbac/` |
| Test ràng buộc và thang cấp | Tester | Lê Sơn Trường | `RbacAndAuthTests`, `RoleHierarchyTests` |

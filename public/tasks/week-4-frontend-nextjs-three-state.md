...
| `useAction`, `ActionFeedback`, thẻ nổi | Developer | Nguyễn Huy Kiên | `lib/useAction.ts`, `components/ui.tsx` |
| Bộ component dùng chung: `Select`, `Combobox`, `Toggle`, `PageHead` | Developer | Nguyễn Huy Kiên | `components/ui.tsx` |
| Màn hình sự cố và phản hồi | Developer | Lê Sơn Trường | `app/projects/[project]/` |
| Màn hình ticket, board, hộp thư | Developer | Lê Sơn Trường | `app/projects/[project]/issues`, `app/boards`, `app/notifications` |
| Hạ tầng i18n và `en.ts` | Developer | Nguyễn Huy Kiên | `lib/i18n.ts`, `lib/messages/en.ts` |
| Test hợp đồng ba trạng thái, i18n, component | Tester | Lê Sơn Trường | `frontend/tests/` |

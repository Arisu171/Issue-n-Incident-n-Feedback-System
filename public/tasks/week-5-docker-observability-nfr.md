...
| Loại sự kiện ticket và bộ phát real-time | Dev lõi | Nguyễn Bảo Long | `Domain/`, `Modules/Tickets/Realtime/` |
| Hạ tầng module: outbox, idempotency, Markdown | Dev lõi | Nguyễn Bảo Long | `Modules/Tickets/Infrastructure/` |
| OpenTelemetry và metric nghiệp vụ | Dev lõi | Nguyễn Bảo Long | `Observability/` |
| `docker-compose.yml`, Dockerfile, healthcheck | Dev lõi | Nguyễn Bảo Long | Gốc repo, `backend/`, `frontend/` |
| `.env.example`, runbook, script sao lưu và phục hồi | Dev lõi | Nguyễn Bảo Long | `.env.example`, `infra/` |
| Chỉ mục tìm kiếm, Query DSL và webhook | Developer | Nguyễn Huy Kiên | `Modules/Tickets/Search/`, `Webhooks/` |
| Job quét ngưỡng SLA và storage tệp đã ký | Developer | Lê Sơn Trường | `Modules/Tickets/Sla/`, `Storage/` |
| Viết kịch bản k6 và tập dữ liệu đo | QA | Nguyễn Bảo Long | `infra/loadtest/` |
| Chạy k6, diễn tập phục hồi, ghi số đo | Tester | Kiên và Trường | `public/docs/verification.md` |

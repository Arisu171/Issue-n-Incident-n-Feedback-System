...
import { ActionFeedback, ErrorBox, Guard, NotFoundView, PageHead, RequiredMark, Select, SubmitButton, isNotFound } from '@/components/ui';
      ...
      {open && (
        <form onSubmit={submit}>
          ...
          <div className="field">
            ...
            <input id="p-cur" className="input" type="password" required autoComplete="current-password"
              value={current} onChange={(e) => setCurrent(e.target.value)} />
          </div>
          <div className="field">
            <label htmlFor="p-new">{tr('Mật khẩu mới')}<RequiredMark /></label>
            <input id="p-new" className="input" type="password" required autoComplete="new-password"
              value={next} onChange={(e) => setNext(e.target.value)} />
          </div>
          <div className="field">
            <label htmlFor="p-cfm">{tr('Nhập lại mật khẩu')}<RequiredMark /></label>
            <input id="p-cfm" className="input" type="password" required autoComplete="new-password"

...
import { ActionFeedback, RequiredMark, SubmitButton } from '@/components/ui';
      ...
      <div className="card">
        ...
        {expired && (
          <div className="alert info">
            {tr('Phiên làm việc đã hết hạn. Access token chỉ sống 15 phút theo ADR-001 và hệ thống chưa có refresh token, nên bạn cần đăng nhập lại.')}
          </div>
        )}

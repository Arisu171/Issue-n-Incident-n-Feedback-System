...
import { ActionFeedback, ErrorBox, Pager, RequiredMark, Select, SubmitButton } from '@/components/ui';
  ...
  return (
    <>
      ...
      <div className="list-section">
        ...
        {load.isProcessing && <div className="empty">{tr('Đang tải…')}</div>}

        {!load.isProcessing && data && (
          <>
                      ...
                      <td>
                        ...
                        {!canManage(user) && (
                          <div className="muted" style={{ fontSize: 12, marginTop: 6 }}>
                            {user.id === me?.id
                              ? tr('Tài khoản của bạn — không tự thao tác được.')
                              : tr('Cấp {v0}, ngang hoặc trên cấp {v1} của bạn.', { v0: user.level, v1: myLevel })}
                          </div>
                        )}
